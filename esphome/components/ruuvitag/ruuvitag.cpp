...
void RuuviTag::dump_config() {
  ...
  LOG_SENSOR("  ", "Equilibrium Vapor Pressure", this->equilibrium_vapor_pressure_);
  LOG_SENSOR("  ", "Air Density", this->air_density_);
  LOG_SENSOR("  ", "Absolute humidity", this->absolute_humidity_);
  LOG_SENSOR("  ", "Dew Point", this->dew_point_);
}
